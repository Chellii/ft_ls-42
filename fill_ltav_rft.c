...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/23 02:32:05 by cel-oiri          #+#    #+#             */
/*   Updated: 2019/11/23 02:47:30 by cel-oiri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ls.h"

t_tabav_lt	*insert_dir_rtf(t_tabav_lt **t, t_tabav_lt *lt)
{
	t_tabav_lt *lt2;
...
t_tabav_lt	*insert_files_rtf_2(t_tabav_lt **t, t_tabav_lt *lt2, t_tabav_lt *lt)
{
	while ((lt2->next) && (!(isdir(lt2->buf)))
...
t_tabav_lt	*insert_files_rtf(t_tabav_lt **t, t_tabav_lt *lt)
{
	t_tabav_lt *lt2;
...
t_tabav_lt	*fill_ltav_rft(t_tabav_lt **t, char *str, t_pars_v *pv)
{
	...
	else
	{
		...
		if (lt->exist == 0)
			...
			(*t) = insert_files_rtf(t, lt);
		else
			(*t) = insert_dir_rtf(t, lt);
	}
	return (*t);
}
